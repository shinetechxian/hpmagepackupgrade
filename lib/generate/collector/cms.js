 ...
 */
const cms = async (browserContext, { cmsUrl, authUsername, authPassword, timeout, args }) => {
    ...
    if(timeout && args.length){
        await page.goto(cmsUrl, { waitUntil: 'networkidle0', timeout: args[0] });
    } else {
        await page.goto(cmsUrl, { waitUntil: 'networkidle0' });
    }
